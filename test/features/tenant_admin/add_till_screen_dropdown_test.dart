...
void main() {
  testWidgets(
    ...
    const baseOptions = TillCreateOptions(
      outlets: [
        TillOutletOption(
            id: 'out1', name: 'Outlet 1', code: 'O1', status: 'ACTIVE'),
        TillOutletOption(
            id: 'out2', name: 'Outlet 2', code: 'O2', status: 'ACTIVE'),
      ],
      cashiers: [
        TillCashierOption(
            id: 'c1', displayName: 'Cashier 1', outletIds: ['out1']),
        TillCashierOption(
            id: 'c2', displayName: 'Cashier 2', outletIds: ['out2']),
      ],
      posDevices: [
        TillPosDeviceOption(
            id: 'p1',
