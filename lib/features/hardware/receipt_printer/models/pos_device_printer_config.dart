...
class PosDevicePrinterConfig {
  ...
  PosDevicePrinterConfig copyWith({
    String? deviceId,
    bool? enabled,
    PrinterConnectionType? connectionType,
    String? displayName,
    PrinterPaperWidth? paperWidth,
    String? escPosProfile,
    bool? autoCutEnabled,
    int? feedLinesBeforeCut,
    int? usbVendorId,
    int? usbProductId,
    String? usbDeviceIdentifier,
    ...
    return PosDevicePrinterConfig(
      ...
      escPosProfile: escPosProfile ?? this.escPosProfile,
      autoCutEnabled: autoCutEnabled ?? this.autoCutEnabled,
      ...
      usbDeviceIdentifier: usbDeviceIdentifier ?? this.usbDeviceIdentifier,
      ...
      agentPrinterName: agentPrinterName ?? this.agentPrinterName,
      configurationId: configurationId ?? this.configurationId,
      configurationVersion: configurationVersion ?? this.configurationVersion,
      supportedPurposes: supportedPurposes ?? this.supportedPurposes,
      printCustomerCopy: printCustomerCopy ?? this.printCustomerCopy,
      customerCopyCount: customerCopyCount ?? this.customerCopyCount,
      printMerchantCopy: printMerchantCopy ?? this.printMerchantCopy,
      merchantCopyCount: merchantCopyCount ?? this.merchantCopyCount,
    );
  }
