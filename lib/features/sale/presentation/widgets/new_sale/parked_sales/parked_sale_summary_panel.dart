...
class ParkedSaleSummaryPanel extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Single catalog code gates summary values (count + value). No independent
    // total_held / total_value child codes exist.
    final showSummaryValues =
        PosSalesPermissionVisibility.canShowHeldSummary(permissions);
    final showStartSale = canStartSale;

    if (!showSummaryValues && !showStartSale) {
      return const SizedBox.shrink();
    }

    final children = <Widget>[];

    if (showSummaryValues) {
      children.add(
        Row(
          children: [
            Container(
      ...
      children.add(const SizedBox(height: TenantAdminSpacing.xs));
      children.add(
        Container(
          padding: const EdgeInsets.all(TenantAdminSpacing.sm),
          decoration: BoxDecoration(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () => context.go('/pos/new-sale'),
                ),
              ),
            ],
          ),
