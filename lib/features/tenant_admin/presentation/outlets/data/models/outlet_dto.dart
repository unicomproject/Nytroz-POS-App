class OutletDto {
  ...
  factory OutletDto.fromJson(Map<String, dynamic> json) {
    return OutletDto(
      ...
      onlineTillCount: _intValue(json['onlineTillCount'] ?? json['onlineTills']),
      staffCount: _intValue(json['staffCount'] ?? json['staff']),
      todaysSales: json['todaysSales']?.toString() ?? json['todaySales']?.toString() ?? '',
    );
  }
...
class OutletDetailsDto {
  ...
  factory OutletDetailsDto.fromJson(Map<String, dynamic> json) {
    return OutletDetailsDto(
      ...
      assignedTills: _mapList(json['assignedTills'], OutletRelatedItemDto.fromJson),
      staff: _mapList(json['staff'], OutletRelatedItemDto.fromJson),
      needsAttention: _mapList(json['needsAttention'], OutletAttentionItemDto.fromJson),
    );
  }
