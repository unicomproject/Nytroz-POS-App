...
import '../../../widgets/tenant_admin_form_section.dart';
import '../../../widgets/tenant_admin_stepper_header.dart';
...
class _OutletFormState extends State<OutletForm> {
  ...
  void initState() {
    ...
    _mainPhoneNumber = TextEditingController(text: initial?.mainPhoneNumber ?? '');
    ...
    switch (_step) {
      ...
      case 1:
        return TenantAdminFormSection(
          ...
          children: [
            _field('addressLine1', 'Address line 1', _addressLine1, isRequired: true),
