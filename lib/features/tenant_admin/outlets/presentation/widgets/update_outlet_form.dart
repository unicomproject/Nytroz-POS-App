...
void main() {
  ...
  final startText = 'class _OutletDetailsStep extends StatelessWidget {';
  final endText = 'class _OutletLocationContactStep extends StatelessWidget {';
  ...
  final newClass = '''class _OutletDetailsStep extends StatelessWidget {
