...
void main() {
  ...
  const startText = '2 => TenantAdminFormSection(';
  const endText = '_ => _OutletReviewStep(';
  ...
  const replacement = '''2 => BusinessHoursEditor(
          hours: _openingHours,
  ...
  // ignore: avoid_print
  print('Successfully updated step 2 to use BusinessHoursEditor');
}
