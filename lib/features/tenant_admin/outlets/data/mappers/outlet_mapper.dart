...
extension TenantAdminOutletOverviewMapper on TenantAdminOutletOverviewDto {
  TenantAdminOutletOverview toEntity() {
    return TenantAdminOutletOverview(
      ...
      city: outlet.city,
      managerId: manager?.tenantUserId,
      ...
      todayNetSales: sales?.todayNetSales ?? 0,
      salesCurrency: sales?.currencyCode ?? 'LKR',
      stockValue: inventory?.stockValue ?? 0,
      inventoryCurrency: inventory?.currencyCode ?? 'LKR',
