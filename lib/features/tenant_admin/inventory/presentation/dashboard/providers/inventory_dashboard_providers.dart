...
final inventoryDashboardOutletIdProvider = StateProvider<String?>((ref) => null);

// Metrics
final inventoryDashboardMetricsProvider = FutureProvider.autoDispose<InventoryDashboardMetricsDto>((ref) {
...
// Alerts
final inventoryDashboardAlertsProvider = FutureProvider.autoDispose<InventoryDashboardAlertsResponseDto>((ref) {
  final outletId = ref.watch(inventoryDashboardOutletIdProvider);
  final repository = ref.watch(inventoryRepositoryProvider);
...
// Activities
final inventoryDashboardActivitiesProvider = FutureProvider.autoDispose<InventoryDashboardActivitiesResponseDto>((ref) {
  final outletId = ref.watch(inventoryDashboardOutletIdProvider);
  final repository = ref.watch(inventoryRepositoryProvider);
