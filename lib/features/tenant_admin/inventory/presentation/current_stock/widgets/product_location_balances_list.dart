      ...
      child: Column(
        ...
        children: [
          ...
          if (detail.locationBalances.isEmpty)
            ...
            Padding(
              padding:
                  const EdgeInsets.symmetric(horizontal: TenantAdminSpacing.xl),
              child: Column(
        ...
        children: [
          ...
          Expanded(
            ...
            child: Row(
              ...
              children: [
                _StatColumn('On Hand', loc.onHand.toStringAsFixed(0),
                    const Color(0xFF3B82F6)),
                _StatColumn('Reserved', loc.reserved.toStringAsFixed(0),
                    const Color(0xFFF97316)),
                _StatColumn('Available', loc.available.toStringAsFixed(0),
