...
class TillReviewSection extends StatelessWidget {
  const TillReviewSection({
    super.key,
    required this.title,
    required this.icon,
    required this.items,
  ...
  final String title;
  final IconData icon;
  final List<TillReviewItem> items;
...
class TillReviewItem {
  const TillReviewItem(this.label, this.value);
