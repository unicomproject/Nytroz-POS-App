...
class TenantAdminPermissionCodes {
  ...
  static const tenantOutletsCreate = 'tenant.outlets.create';
  ...
  static const tenantOutletsStatusUpdate = 'tenant.outlets.status.update';
  static const tenantOutletsManagerAssign = 'tenant.outlets.manager.assign';
  static const tenantOutletsImageUpdate = 'tenant.outlets.image.update';
  static const tenantOutletsDelete = 'tenant.outlets.delete';
  ...
  static const tenantUsersRolesAssign = 'tenant.users.roles.assign';
  static const tenantUsersOutletsAssign = 'tenant.users.outlets.assign';
  static const tenantUsersTillsAssign = 'tenant.users.tills.assign';
  static const tenantUsersInvitesResend = 'tenant.users.invites.resend';
  static const tenantUsersInvitesRevoke = 'tenant.users.invites.revoke';
  ...
  static const tenantRolesUpdate = 'tenant.roles.update';
  static const tenantRolesDelete = 'tenant.roles.delete';
  static const tenantRolesPermissionsView = 'tenant.roles.permissions.view';
  static const tenantRolesPermissionsUpdate = 'tenant.roles.permissions.update';
  static const tenantRolesAssignmentsView = 'tenant.roles.assignments.view';
  static const tenantRolesAssignmentsUpdate = 'tenant.roles.assignments.update';
  static const tenantRolesStatusUpdate = 'tenant.roles.status.update';
  static const tenantRolesUsersAssign = 'tenant.roles.users.assign';
  static const tenantRolesOutletsAssign = 'tenant.roles.outlets.assign';
  static const tenantRolesManage = 'tenant.roles.manage';
  ...
  static const tenantTillsAssignOutlet = 'tenant.tills.assign_outlet';
